            ...
            <div class="right-side">
                                 ...
                                 <li class="notifications-not-read">
                                    <a href="dashboard-manage-candidates.html">
                                       ...
                                       <span class="notification-text">
                                          <strong>Michael Shannah</strong> applied for a job <span class="color">Full Stack
                           ...
                           <div class="header-notifications-scroll" data-simplebar>
                              <ul>
                                 ...
                                 <li class="notifications-not-read">
                                    <a href="dashboard-messages.html">
                                       <span class="notification-avatar status-online"><img
                                             src="../assets/images/user-avatar-small-03.jpg" alt=""></span>
                                 ...
                                 <li class="notifications-not-read">
                                    <a href="dashboard-messages.html">
                                       <span class="notification-avatar status-offline"><img
                                             src="../assets/images/user-avatar-small-02.jpg" alt=""></span>
                                       <div class="notification-text">
                                 ...
                                 <li class="notifications-not-read">
                                    <a href="dashboard-messages.html">
                                       <span class="notification-avatar status-online"><img
                                             src="../assets/images/user-avatar-placeholder.png" alt=""></span>
                                       <div class="notification-text">
               ...
               <div class="header-widget">
                  ...
                  <div class="header-notifications user-menu">
                     <div class="header-notifications-trigger">
                        <a href="#">
                           <div class="user-avatar status-online"><img src="../assets/images/user-avatar-small-01.jpg"
                                 alt=""></div>
                        </a>
                     </div>
